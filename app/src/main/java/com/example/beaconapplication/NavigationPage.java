...
public class NavigationPage extends AppCompatActivity {
    ...
    private Scanner_Navigation mBTLeScanner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.hide();
        mBTLeScanner = new Scanner_Navigation(this, 1000, -500);
        ...
        Showdisplayroute = (TextView) findViewById(R.id.dis_route);
        Showdisplaynow = (TextView) findViewById(R.id.dis_roomnow);
        ...
        dismap = findViewById(R.id.dis_map);

        Btn_back = findViewById(R.id.dis_btn_back);
        Btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                findcomplete = true;
                Intent intent = new Intent(NavigationPage.this, ListRoom.class);
        ...
        Start = (Button) findViewById(R.id.dis_btn_start);
                ...
                new AlertDialog.Builder(this)
                        .setPositiveButton(R.string.app_name, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ActivityCompat.requestPermissions(NavigationPage.this,
